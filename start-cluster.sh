...
docker run -d --dns 127.0.0.1 -p 33003:22 -e NODE_TYPE=s -P --name slave3 -h dn2.xiahoufeng.com -e JOIN_IP=$FIRST_IP xiahoufeng/hadoop-dn
docker run -d --dns 127.0.0.1 -p 33004:22 -e NODE_TYPE=s -P --name slave4 -h dn2.xiahoufeng.com -e JOIN_IP=$FIRST_IP xiahoufeng/hadoop-dn
docker run -d --dns 127.0.0.1 -p 33005:22 -e NODE_TYPE=s -P --name slave5 -h dn2.xiahoufeng.com -e JOIN_IP=$FIRST_IP xiahoufeng/hadoop-dn
